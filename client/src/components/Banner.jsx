...
const Banner = () => {
	return (
		<motion.div
			// Animate the whole banner: fade in + slide up when it comes into view
		...
		>
			...
			<div className="text-white">
				...
				{/* Call-to-action button with hover and click animation */}
				<motion.button
			...
			{/* Right side: banner car image with delayed animation */}
			<motion.img
				initial={{ opacity: 0, x: 50 }} // Start off-screen to the right
				whileInView={{ opacity: 1, x: 0 }} // Slide in and fade in
				transition={{ duration: 0.6, delay: 0.4 }} // Delay for stagger effect
